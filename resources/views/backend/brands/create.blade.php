        ...
        <div class="card my_card">
            <div class="card-header bg-transparent">
                <a href="{{route('brand')}}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    ...
                    <span class="create_sub_title">Brand အသစ်ဖန်တီးမည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                    ...
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('brand.store')}}" id="brand_create" enctype="multipart/form-data">
                            ...
                            <div class="text-end submit-m-btn">
                                <button type="submit" class="submit-btn">Brand အသစ်ပြုလုပ်မည်</button>
                            </div>
                        </form>
                    </div>
                </div>
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreBrandRequest', '#brand_create') !!}
