        ...
        <div class="card my_card">
            <div class="card-header bg-transparent">
                <a href="{{route('currencies.index')}}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    ...
                    <span class="create_sub_title">Currency သတ်မှတ်မည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="kyats" placeholder="Enter Myanmar currency value" aria-label="Enter Myanmar currency value" aria-describedby="basic-addon2">
                                        <span class="input-group-text" id="basic-addon2">Kyats</span>
                                    </div>
                                </div>
                            </div>
                            <div class="text-end submit-m-btn">
                                <button type="submit" class="submit-btn">currency သတ်မှတ်မည်</button>
                            </div>
                        </form>
                    </div>
                </div>
