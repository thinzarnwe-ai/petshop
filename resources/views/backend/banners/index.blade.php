...
@section('content')
    <div class="card category my_card">
        <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
            <h5 class="mb-0 text-dark">Banners - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\Banner::count() }}</div></h5>
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="datatable" style="width:100%;">
                    <thead class="text-center  text-muted" style="background: #F3F6F9">
                        ...
                        <th class="text-center no-sort">ခေါင်းစဉ်</th>
