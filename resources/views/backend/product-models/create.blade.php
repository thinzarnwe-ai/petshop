        ...
        <div class="card my_card">
            <div class="card-header bg-transparent">
                <a href="{{route('product.model')}}" class="card-title mb-0 d-inline-flex align-items-center create_title">
                    ...
                    <span class="create_sub_title">Product Model အသစ်ဖန်တီးမည်</span>
                </a>
            </div><!-- end card header -->
            <div class="card-body">
                <div class="row d-flex justify-content-center">
                    <div class="col-xl-9">
                        <form method="POST" action="{{route('product.model.store')}}" id="category_create" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="text-end submit-m-btn">
                                <button type="submit" class="submit-btn">Product Model အသစ်ပြုလုပ်မည် </button>
                            </div>
                        </form>
                    </div>
                </div>
