...
<div class="card brand my_card">
    <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
            <h5 class="mb-0 text-dark">Type - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\Type::count() }}</div></h5>
            <a class="primary_button" href="{{route('product.type.create')}}">
                <div class="d-flex align-items-center">
                    <i class=" ri-add-circle-fill mr-2 primary-icon"></i>
                    <span class="button_content">Product type အသစ်ဖန်တီးမည်</span>
                </div>
            </a>
        </div>
    ...
    <script>
      $(document).ready(function() {
            let table = $('#datatable').DataTable( {
                ...
                serverSide: true,
                responsive: true,
                ajax: "/products/types/datatable/ssd",
                language : {
