...
<div class="card my_card">
    <div class="card-header d-flex justify-content-between align-items-center bg-transparent">
            <h5 class="mb-0 text-dark">Watts - <div class="badge badge-myColor" id="badgeTotalCount">{{ App\Models\ProductSize::count() }}</div></h5>
            <a class="primary_button" href="{{route('product.size.create')}}">
                <div class="d-flex align-items-center">
                    <i class=" ri-add-circle-fill mr-2 primary-icon"></i>
                    <span class="button_content">Watt အသစ်ဖန်တီးမည်</span>
                </div>
            </a>
        </div>
